    ...
    for (const id in elements) {
      ...
      switch (element.class) {
        case 'track':
          ...
          break
        case 'turnout':
          this.turnouts.push(new LayoutSegmentTurnout(element.x, element.y, element.type))
          break
        case 'surface':
          this.surfaces.push(new LayoutSegmentSurface(element.x, element.y, element.w, element.h, element.color, element.text))
          break
        case 'signal':
          this.signals.push(new LayoutSegmentSignal(element.x, element.y, element.type, element.bulbs))
          break
        default:
