    ...
    switch (this.type) {
      ...
      case 'lt45turn':
        ...
        context.bezierCurveTo(
          straightlength + beziercorr, bs / 2,
      ...
      case 'rt45turn':
        ...
        context.lineTo(bs - straightlength, bs / 2)
        context.bezierCurveTo(
          bs - straightlength - beziercorr, bs / 2,
      ...
      case 'tl45turn':
        context.moveTo(bs / 2, 0)
        context.lineTo(bs / 2, straightlength)
        context.bezierCurveTo(
          bs / 2, straightlength + beziercorr,
          beziercorr, bs - beziercorr,
          0, bs)
        break
      case 'tr45turn':
      ...
      case 'bl45turn':
        ...
        context.lineTo(bs / 2, bs - straightlength)
        context.bezierCurveTo(
          bs / 2, bs - straightlength - beziercorr,
          beziercorr, beziercorr,
          0, 0)
        break
      case 'br45turn':
