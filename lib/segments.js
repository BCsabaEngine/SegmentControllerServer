...
class Segment extends EventEmitter {
  ...
  GetValidPanels() {
    ...
    if (this.turnout1.initialized) panels['Turnout 1'] = { version: this.turnout1.GetVersion(), uptime: this.turnout1.GetUptimeHuman() }
    if (this.turnout2.initialized) panels['Turnout 2'] = { version: this.turnout2.GetVersion(), uptime: this.turnout2.GetUptimeHuman() }
    if (this.turnout3.initialized) panels['Turnout 3'] = { version: this.turnout3.GetVersion(), uptime: this.turnout3.GetUptimeHuman() }
    if (this.turnout4.initialized) panels['Turnout 4'] = { version: this.turnout4.GetVersion(), uptime: this.turnout4.GetUptimeHuman() }

    if (this.signal1.initialized) panels['Signal 1'] = { version: this.signal1.GetVersion(), uptime: this.signal1.GetUptimeHuman() }
    if (this.signal2.initialized) panels['Signal 2'] = { version: this.signal2.GetVersion(), uptime: this.signal2.GetUptimeHuman() }
    if (this.signal3.initialized) panels['Signal 3'] = { version: this.signal3.GetVersion(), uptime: this.signal3.GetUptimeHuman() }
    if (this.signal4.initialized) panels['Signal 4'] = { version: this.signal4.GetVersion(), uptime: this.signal4.GetUptimeHuman() }

    if (this.keypad.initialized) panels['Keypad'] = { version: this.keypad.GetVersion(), uptime: this.keypad.GetUptimeHuman() }

    if (this.sound.initialized) panels['Sound'] = { version: this.sound.GetVersion(), uptime: this.sound.GetUptimeHuman() }

    if (this.ambientlight1.initialized) panels['AmbientLight 1'] = { version: this.ambientlight1.GetVersion(), uptime: this.ambientlight1.GetUptimeHuman() }
    if (this.ambientlight2.initialized) panels['AmbientLight 2'] = { version: this.ambientlight2.GetVersion(), uptime: this.ambientlight2.GetUptimeHuman() }
    if (this.ambientlight3.initialized) panels['AmbientLight 3'] = { version: this.ambientlight3.GetVersion(), uptime: this.ambientlight3.GetUptimeHuman() }
    if (this.ambientlight4.initialized) panels['AmbientLight 4'] = { version: this.ambientlight4.GetVersion(), uptime: this.ambientlight4.GetUptimeHuman() }
