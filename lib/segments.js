...
class Segment extends EventEmitter {
  ...
  GetValidPanels() {
    ...
    if (this.master.initialized) panels['MasterBoard'] = { version: this.master.GetVersion() }

    if (this.turnout1.initialized) panels['Turnout 1'] = { version: this.turnout1.GetVersion() }
    if (this.turnout2.initialized) panels['Turnout 2'] = { version: this.turnout2.GetVersion() }
    if (this.turnout3.initialized) panels['Turnout 3'] = { version: this.turnout3.GetVersion() }
    if (this.turnout4.initialized) panels['Turnout 4'] = { version: this.turnout4.GetVersion() }

    if (this.signal1.initialized) panels['Signal 1'] = { version: this.signal1.GetVersion() }
    if (this.signal2.initialized) panels['Signal 2'] = { version: this.signal2.GetVersion() }
    if (this.signal3.initialized) panels['Signal 3'] = { version: this.signal3.GetVersion() }
    if (this.signal4.initialized) panels['Signal 4'] = { version: this.signal4.GetVersion() }

    if (this.keypad.initialized) panels['Keypad'] = { version: this.keypad.GetVersion() }

    if (this.sound.initialized) panels['Sound'] = { version: this.sound.GetVersion() }

    if (this.ambientlight1.initialized) panels['AmbientLight 1'] = { version: this.ambientlight1.GetVersion() }
    if (this.ambientlight2.initialized) panels['AmbientLight 2'] = { version: this.ambientlight2.GetVersion() }
    if (this.ambientlight3.initialized) panels['AmbientLight 3'] = { version: this.ambientlight3.GetVersion() }
    if (this.ambientlight4.initialized) panels['AmbientLight 4'] = { version: this.ambientlight4.GetVersion() }
